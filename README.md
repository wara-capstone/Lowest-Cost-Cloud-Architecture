...
[[한국 정보기술 학회 2023년도 추계종합학술대회](https://www.dbpia.co.kr/journal/articleDetail?nodeId=NODE11652007)]
...
두 시나리오 모두 최대 히트 수는 같지만, '3tier-test-2.lrr'는 평균 처리량이 더 높고 표준 편차가 낮다. 이는 이 시나리오가 일관되게 더 많은 데이터를 처리할 수 있음을 의미한다. 
